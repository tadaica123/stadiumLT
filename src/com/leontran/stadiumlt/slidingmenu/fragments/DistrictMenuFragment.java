...
import com.leontran.stadiumlt.home.ListViewAdapterDistrict;
...
public class DistrictMenuFragment extends ListFragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		parseXml(R.menu.slide);
		ArrayList<String> district = new ArrayList<String>();
		for (int i = 0 ; i < menuItemList.size() ; i ++ ){
			district.add(menuItemList.get(i).label);
		}
		ListViewAdapterDistrict colorAdapter = new ListViewAdapterDistrict(
